...
<template>
  <aside class="lg:inline-block overflow-y-scroll w-56 border-r bg-white dark:bg-gray-800 dark:border-gray-600"
         style="height: calc(100% - 4.5rem); box-sizing: border-box;">
    <div class="px-4 py-4 flex flex-col"
         style="height: 100%; box-sizing: border-box;">
      <h2 class="pl-1 text-xl font-semibold text-gray-800 dark:text-white" style="height: 1.75rem;">상세 검색</h2>
      <div class="flex flex-col justify-between mt-6"
           style="height: calc(100% - 1.75rem);">
        <nav>
          <a class="flex items-center px-3 py-2 text-gray-700 bg-gray-200 rounded-md dark:bg-gray-700 dark:text-gray-200"
             href="#">
            ...
            <span class="ml-4 font-medium">가격</span>
          </a>
          <a class="flex items-center px-3 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
             href="#">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="ml-4 font-medium">판매자 빵등급</span>
          </a>
          <a class="flex items-center px-3 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
             href="#">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="ml-4 font-medium">책 상태</span>
          </a>
          ...
          <a class="flex items-center px-3 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
            ...
            <span class="ml-4 font-medium">찜 목록</span>
          </a>
          <a class="flex items-center px-3 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
             href="#">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="ml-4 font-medium">설정</span>
          </a>
        </nav>
