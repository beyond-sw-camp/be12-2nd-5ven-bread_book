    ...
    <div class="w-full py-8">
      ...
      >
        ...
        <div class="flex flex-col items-center my-8">
          <!-- 프로필 이미지 미리보기 -->
          <div
            class="w-48 h-48 overflow-hidden border border-gray-300"
          >
            <img
        ...
        <form action="/" class="my-8 text-sm">
            <div class="flex flex-col my-4">
                ...
                <input type="file" id="image_url" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900" >
            </div>
        </form>
