...
<main class="flex pt-16">
    <aside class="fixed pt-12 pb-24 flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white"> 상세 검색</h2>
            ...
            <nav>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
                   href="#">
                    ...
                    <span class="mx-4 font-medium">상품 상태</span>
                </a>
    ...
    <section class="flex-1"
        ...
        <div class="pt-12  bg-white flex flex-col items-center text-center" style="margin-bottom: 3rem;">
            <h2 class="text-center text-2xl text-gray-800 font-bold">'<span style="color: #1D4ED8;">한강</span>'에 대한 <span
                    style="color: #1D4ED8;">9</span>개의 검색결과</h2>
        </div>
        ...
        <div class="relative max-w-2xl mx-auto"
            ...
            <div class="flex items-center space-x-2">
                ...
                <button id="toggle-button"
                        class="round flex items-center border border-gray-300 bg-white text-gray-700 text-sm rounded hover:bg-gray-100"
                        style="padding: 0.5rem 1rem;">
                    <img src="./assets/img/category-toggle-btn.svg" alt="category-toggle">
                    <!--                    <span style="margin-left: 0.5rem; font-weight: bold">분류</span>-->
                </button>
                <!-- 검색 바 -->
            ...
            <!-- 카테고리 선택 필터 -->
            <div id="category-container" class="absolute hidden border bg-white shadow-lg p-4 mt-1 z-50 flex">
                <!-- 왼쪽 카테고리 (1계층) -->
                <div id="level1" class="w-36 flex-shrink-0">
                    <!-- 동적으로 생성된 버튼 -->
                </div>
                <!-- 중간 카테고리 (2계층) -->
                <div id="level2" class="w-36 flex-shrink-0 hidden">
                    <!-- 동적으로 생성된 버튼 -->
                </div>
                <!-- 오른쪽 카테고리 (3계층) -->
                <div id="level3" class="w-36 flex-shrink-0 hidden">
                    <!-- 동적으로 생성된 버튼 -->
                </div>
            </div>
        </div>
        ...
        <section class="py-10 bg-gray-100">
            <div class="mx-auto grid max-w-6xl  grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <article
                    ...
                    <a href="#">
                        <div class="relative flex items-end overflow-hidden rounded-xl">
                            <img src="https://contents.kyobobook.co.kr/sih/fit-in/458x0/pdt/9788932024639.jpg"
                        ...
                        <div class="mt-1 p-2">
                            <h2 class="text-slate-700">「서랍에 저녁을 넣어두었다」한강</h2>
                            <p class="mt-1 text-sm text-slate-400"> 문학과지성사 · 2013년 11월 15일</p>

                            <div class="mt-3 flex items-end justify-between">
                                <p class="text-lg font-bold text-blue-500">10,000원</p>
                ...
                <article
                    ...
                    <a href="#">
                        <div class="relative flex items-end overflow-hidden rounded-xl">
                            <img src="https://contents.kyobobook.co.kr/sih/fit-in/458x0/pdt/9788936434595.jpg"
                                 alt="채식주의자 한강"/>
                        ...
                        <div class="mt-1 p-2">
                            <h2 class="text-slate-700">「채식주의자」한강</h2>
                            <p class="mt-1 text-sm text-slate-400">창비 · 2022년 03월 28일</p>

                            <div class="mt-3 flex items-end justify-between">
                                <p class="text-lg font-bold text-blue-500">12,000원</p>
                ...
                <article
                    ...
                    <a href="#">
                        <div class="relative flex items-end overflow-hidden rounded-xl">
                            <img src="https://contents.kyobobook.co.kr/sih/fit-in/458x0/pdt/9788936434120.jpg"
                                 alt="「소년이 온다」한강"/>
                            <div
                                    class="flex items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="mt-1 p-2">
                            <h2 class="text-slate-700">「소년이 온다」한강</h2>
                            <p class="mt-1 text-sm text-slate-400">창비 · 2014년 05월 19일</p>

                            <div class="mt-3 flex items-end justify-between">
                                <p class="text-lg font-bold text-blue-500">11,000원</p>
                                <div
                                        class="flex items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                                    <img src="./assets/img/white-star.svg" alt="찜">
